...
public class DecisaoEncadeada {
	...
	public static void main(String[] args) {
		...
		if (faltas>20) {
			...
			if (media>=6) {
				System.out.println("Aluno " + nome + " Parabens, você está aprovado!!");
			}else if (media<4) {
				System.out.println("Infelizmente  " + nome + " você foi reprovado!!!");

			}else {
				System.out.println( nome + " Você ainda tem chance!");
...
//System.out.println("Aluno: " + nome + " Sua média foi : " + media);
//short faltas = Short.parseShort(JOptionPane.showInputDialog("Digite o número total de faltas"));